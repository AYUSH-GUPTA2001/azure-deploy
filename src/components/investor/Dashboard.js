...
// }, []);
  const columns = [
    ...
    { field: 'investmentAmount',width:150 ,editable:true, headerName: 'Amount(Rs)' ,headerClassName: 'super-app-theme--header', },
     { field: 'timePeriod',width:140, headerName: 'Time Period',backgroundColor: '#4b49ac' ,headerClassName: 'super-app-theme--header', },
    { field: 'returnPercentageAfter6months', width:140 , headerName: '6M Return(%)',headerClassName: 'super-app-theme--header', },
